...
class SyntaxHighlighterStyle {
  ...
  static final commonSize = duSetFontSize(18);

  static SyntaxHighlighterStyle defaultStyle() {
    return new SyntaxHighlighterStyle(
        baseStyle: new TextStyle(color: AppTheme.descText, fontSize: commonSize),
        numberStyle: new TextStyle(color: Colors.blue[800], fontSize: commonSize),
        commentStyle: new TextStyle(color: Color.fromRGBO(124, 126, 120, 1.0), fontSize: commonSize),
        keywordStyle: new TextStyle(color: Color.fromRGBO(228, 125, 246, 1.0), fontSize: commonSize),
        stringStyle: new TextStyle(color: Color.fromRGBO(150, 190, 118, 1.0), fontSize: commonSize),
        punctuationStyle:
            new TextStyle(color: Color.fromRGBO(212, 212, 212, 1.0), fontSize: commonSize),
        classStyle: new TextStyle(color: Color.fromRGBO(150, 190, 118, 1.0), fontSize: commonSize),
        constantStyle: new TextStyle(color: Colors.brown[500], fontSize: commonSize));
  }
